...
const Spotify = {
    getAccessToken(){
        ...
        const accessTokenMatch = window.location.href.match(/access_token=([^&]*)/); // get location url currently at
        ...
        if (accessTokenMatch && expireInMatch) {
           ...
           const expiresIn = Number(expireInMatch[1]);
            // This clears params allowing u to grab new access token when it expires
